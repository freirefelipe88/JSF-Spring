...
public class MBeanDepartment {
	...
	public void save(){
		if(this.validateForm()){
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(String.format("Department [%s] saved with success!", this.getDepartment().getName())));
	...
	public void update(){
		...
		if(this.validateForm()){
			...
			this.setRenderGlobalMessage(true);
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(String.format("Department [%s] updated with success!", this.getDepartment().getName())));
	...
	public void delete(){
		...
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(String.format("Department [%s] removed with success!", this.getDepartment().getName())));
		this.reloadView();
	}
