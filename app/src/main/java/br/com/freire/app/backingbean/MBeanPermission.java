...
public class MBeanPermission {
	...
	public void save(){
		if(this.validateForm()){
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(String.format("Permission [%s] saved with success!", this.getPermission().getName())));
	...
	public void update(){
		...
		if(this.validateForm()){
			...
			this.setRenderGlobalMessage(true);
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(String.format("Permission [%s] updated with success!", this.getPermission().getName())));
	...
	public void delete(){
		...
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(String.format("Permission [%s] removed with success!", this.getPermission().getName())));
		this.reloadView();
	}
	...
	public void associateUser(){
		...
		for (User user : userList) {
			...
			UserHasPermissions userPermissions = new UserHasPermissions(new UserHasPermissionPK(user.getId(), this.getPermission().getId()));
